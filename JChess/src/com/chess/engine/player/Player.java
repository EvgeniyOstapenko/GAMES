...
public abstract class Player {
    ...
    protected static Collection calculateAttackOnTile(int piecePosition, Collection<Move> moves) {
    ...
    public MoveTransition makeMove(final Move move) {
        ...
        // making the real moves with a new board..
        final Board transitionBoard = move.execute();

        // Is a king in a shah position?
...
//  move -> transitionBoard with switch the player -> currentPlayer  -> opponentKing
